...
public class ChannelView extends MasterView {
    private static String TAG = "ChannelView";
    ...
    public ChannelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.component_channel, this, true);
        createPie();
    ...
    private void loadToServer(String event_id){
        try {
            ...
            JSONArray ja        =new JSONArray();
            {
                ...
                jo.put("key","Internet/Website");
                jo.put("value","33");
                ja.put(jo);
            }
            {
                JSONObject jo = new JSONObject();
                jo.put("key","CMS/Website");
                jo.put("value","67");
                ja.put(jo);
            }
            setDataPie(ja);
