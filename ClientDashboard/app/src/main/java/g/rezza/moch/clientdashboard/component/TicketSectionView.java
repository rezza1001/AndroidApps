...
public class TicketSectionView extends MasterView {
    public static String TAG = "TicketSectionView";

    private PieChart pchrt_report_04;

    public TicketSectionView(Context context) {
        super(context);
    }

    public TicketSectionView(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.component_ticket_section, this, true);
        createPie();
    }
