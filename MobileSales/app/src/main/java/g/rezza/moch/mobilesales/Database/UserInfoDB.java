...
public class UserInfoDB {
    ...
    public static final String FIELD_MC_CODE    = "MC_CODE";
    ...
    public ContentValues createContentValues(){
        ...
        contentValues.put(FIELD_MC_CODE, mc_code);
    ...
    public void getData(Context context, int userID){
        Database pDB = new Database(context);
        ...
        try {
            while (res.moveToNext()){
                ...
                this.mc_code        = res.getString(res.getColumnIndex(FIELD_MC_CODE));
            }
            pDB.close();
        }catch (Exception e){
            Log.d(TAG,e.getMessage());
