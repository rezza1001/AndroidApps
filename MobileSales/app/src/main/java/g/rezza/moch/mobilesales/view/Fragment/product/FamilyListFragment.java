...
public class FamilyListFragment extends ScrollTabHolderFragment{
	...
	public static Fragment newInstance(int position) {
		FamilyListFragment f = new FamilyListFragment();
		Bundle b = new Bundle();
	...
	private void loadData(){
		...
		kvs.add(new KeyValueHolder("category_id", App.KIOSTIX_FAMILY));
		post.setData(kvs);
		post.execute("POST");
