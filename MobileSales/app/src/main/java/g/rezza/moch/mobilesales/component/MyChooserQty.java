...
public class MyChooserQty extends RelativeLayout implements View.OnClickListener{
    ...
    public MyChooserQty(Context context, AttributeSet attrs) {
        ...
        imvw_minus.setImageResource(R.drawable.ic_minus);
        imvw_plus.setImageResource(R.drawable.ic_plus);
