...
public class TopUpReqAdapter extends ArrayAdapter<NotificationHolder> {
    public static final String TAG = "TopUpReqAdapter";

    private ArrayList<NotificationHolder> holders = new ArrayList<>();
    public static final int RESOURCE = R.layout.adapter_notification;

    public TopUpReqAdapter(@NonNull Context context, ArrayList<NotificationHolder> pElement) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        try {
            ...
            if (holder != null){
                ...
                txvw_who_00.setText(holder.status_desc);
                ...
                if (holder.status == holder.IN_PROGRESS){
                    ...
                    rvly_store_00.setBackgroundResource(R.drawable.adapter_store_red);
                }
                else if (holder.status == holder.APPROVE){
