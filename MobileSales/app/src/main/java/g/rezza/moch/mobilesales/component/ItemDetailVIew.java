...
public class ItemDetailVIew extends RelativeLayout implements View.OnClickListener {
    ...
    public ItemDetailVIew(Context context, @Nullable AttributeSet attrs) {
        ...
        imvw_status_00.setBackgroundResource(R.drawable.ic_cursor_right);
    ...
    public void onClick(View view) {
        if (isOpen){
            ...
            isOpen  = true;
            imvw_status_00.setBackgroundResource(R.drawable.ic_cursor_down);
        }
    ...
    public interface OnClickPanelListener{
        public void onClick(android.view.View view, boolean open);
    }
}
