...
public class FieldTransDtl extends RelativeLayout {

    private TextView txvw_key_00;
    private TextView txvw_value_00;
    public FieldTransDtl(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.component_field_transdtl, this, true);
