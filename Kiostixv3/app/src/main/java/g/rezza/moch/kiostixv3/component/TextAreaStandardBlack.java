...
public class TextAreaStandardBlack extends RelativeLayout {
    ...
    public TextAreaStandardBlack(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.component_textarea_black, this, true);
        createLayout();
    }
