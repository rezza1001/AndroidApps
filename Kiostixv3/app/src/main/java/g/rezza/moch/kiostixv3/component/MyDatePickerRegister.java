...
public class MyDatePickerRegister extends RelativeLayout {
    ...
    public MyDatePickerRegister(Context context) {
        super(context);
    }

    public MyDatePickerRegister(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.component_mydatepicker_register, this, true);
    ...
    public String getValue() {
        try {
            dateFormat1.parse(edtx_00.getText().toString());
