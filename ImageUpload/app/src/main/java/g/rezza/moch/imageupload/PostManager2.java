...
public class PostManager2 extends AsyncTask<String, Void, String> {
...
//    private String url             = "http://202.154.3.188/commerce/sandbox-unilever-middleware/core-services";
    private String url              = "http://imageupload.mybarber.my.id/api/image-upload";
    ...
    public PostManager2(Context mContext){
...
//            httpURLConnection.setRequestProperty("Connection", "Keep-Alive"); // here you are setting the `Content-Type` for the data you are sending which is `application/json`
//            httpURLConnection.setRequestProperty("Cache-Control", "no-cache"); // here you are setting the `Content-Type` for the data you are sending which is `application/json`
