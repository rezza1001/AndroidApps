...
public class DeviceListAdapter extends  BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView			=  mInflater.inflate(R.layout.adapter_devicelist, null);
        ...
        holder.imvw_bluetooth_10.setImageResource(R.drawable.ic_bluetooth);
